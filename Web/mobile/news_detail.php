...
<head>
    <meta charset="utf-8">
    <title>【家·印记品鉴会特别报导】</title>
    <meta name="Keywords" content="【家·印记品鉴会特别报导】" />
    <meta name="Description" content="【家·印记品鉴会特别报导】" />
...
<article class="weui_article">
    ...
    <div class="editor-content detail-con">
        ...
        </div>video/jiayinji.jpg
        <p style="font-size: 14px;">
            【家·印记品鉴会特别报导】你在茫然，你在徘徊中，人家是在稳定中继续发展。<br><br>
            <img src="img/temp/2.1.jpg">
            ...
            13393193323冯鑫<br>
            18912785199何平
            <img src="img/temp/3.jpg"><br>
            <img src="img/temp/4.jpg"><br>
            <img src="img/temp/5.jpg"><br>
            <img src="img/temp/6.jpg"><br>
            <img src="img/temp/7.jpg"><br>
            <img src="img/temp/8.jpg"><br>
        </p>
        <?php if($_GET['type'] == 1){ ?>
            <div class="more-news">
