...
<head>
    <meta charset="utf-8">
    <title>本期播报要点——【名人访谈】大伟老师谈《旅拍门市接单标准》</title>
    <meta name="Keywords" content="本期播报要点——【名人访谈】大伟老师谈《旅拍门市接单标准》" />
    <meta name="Description" content="本期播报要点——【名人访谈】大伟老师谈《旅拍门市接单标准》" />
...
<article class="weui_article">
    <h1>本期播报要点——【名人访谈】大伟老师谈《旅拍门市接单标准》</h1>
    <div class="editor-content detail-con">
        ...
        <p style="font-size: 14px;">
            一套完整流程解决接单技巧(建议：WiFi下观看!)
            <img src="img/temp/6.1.jpg">
        </p>
        <p style="font-size: 14px;">
            欢迎提供行业价值新闻，我们将第一时间播报。联系人：冯大羽老师18851511648。
        </p>
        <p style="font-size: 14px;">
            【新闻快播】播报最新、最快、最劲爆的行业资讯。
        </p>
        <?php if($_GET['type'] == 1){ ?>
            <div class="more-news">
